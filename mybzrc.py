...
class MyBZRC:
    ...
    def get_lots_o_stuff(self):
        """Network-optimized request for mytanks, othertanks, flags, bases, obstacles and shots.
        ...
        self.read_ack()
        bases = self.read_bases()
        self.read_ack()
        obstacles = self.read_obstacles()
        self.read_ack()
        shots = self.read_shots()

        return (mytanks, othertanks, flags, bases, obstacles, shots)
